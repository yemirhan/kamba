...
export const KategoriPusher = ({
  ...
  form: UseFormReturnType<categoryPusherTypes>;
  itemList: any[];
  setItemList: React.Dispatch<React.SetStateAction<categoryPusherTypes[]>>;
  newItem: boolean;
